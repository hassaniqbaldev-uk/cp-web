...
| `/services/security` | Web Security & Protection | Security buyer | Solid, but narrow | **KEEP as a service** — **O14 CLOSED (19 Aug): we DO deliver standalone security** (malware removal, firewall configuration, monitoring). Sits under **Growth & Performance**; meta description **restored** (rules-compliant). Overrides the earlier D36 demote-to-capability default |
...
| `/services/security` | Web Security Services & Protection \| Free Website Audit | Web Security & Protection | **RESTORED — O14 closed, we deliver standalone security.** Written to staging: "Website security: audits, malware removal, firewall configuration and monitoring to keep your site and the people who use it protected from common threats." |
