...
| `specialistLinks` | array of object `{ label: string, href: string, description: text }` | The "specialisms that are part of this offer" band (down/sideways links). **Hidden unless there are 2+ links** | Optional | Section not rendered (0 or 1 link) |
