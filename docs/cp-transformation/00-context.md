...
| D43 | **Migrations and Accessibility sit under Web & Ecommerce**, not Growth & Performance. | They are **build and delivery capabilities**, not growth services. Resolves the cross-cutting flag from CP-02 §8. Inherited by CP-03 (pillar map). |
