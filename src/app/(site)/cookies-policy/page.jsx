        ...
        <div className="mx-auto max-w-[120rem] px-[3rem] xl:px-[0rem]">
          ...
          <div className="my-[4rem] flex flex-col items-center text-center md:my-[6rem] xl:items-start xl:text-left">
            ...
            <div className="mt-[2rem] flex flex-col gap-[2rem] text-left">
              <p className="text-[1.6rem] leading-[2.4rem] font-medium">
                Cookies consist of portions of code installed in the browser
                that assist the Owner in providing the Service according to the
                purposes described.
              </p>
          ...
          <div className="my-[4rem] flex flex-col items-center text-center md:my-[6rem] xl:items-start xl:text-left">
            ...
            <div className="mt-[2rem] flex flex-col gap-[2rem] text-left">
              ...
              <p className="text-[1.6rem] leading-[2.4rem] font-medium">
                ...
                the relevant provider. Some of them expire upon termination of
                the User's browsing session.
              </p>

              <p className="text-[1.6rem] leading-[2.4rem] font-medium">
                In addition to what's specified in the descriptions within each
                of the categories below, Users may find more precise and updated
                information regarding lifetime specification as well as any
                other relevant information — such as the presence of other
                  ...
                  <div className="flex flex-col gap-[2rem]">
                    <div className="flex flex-col gap-[.5rem]">
                      <p className="max-w-[60rem] text-[1.6rem] leading-[2.4rem] font-medium">
                        ...
                        other similar Trackers to carry out activities that are
                        strictly necessary for the operation or delivery of the
                        Service.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-[2rem]">
                    ...
                    <div className="flex flex-col gap-[.5rem]">
                      ...
                      <p className="max-w-[60rem] text-[1.6rem] leading-[2.4rem] font-medium">
                        ...
                        the browser can tell its script not to collect any of
                        the User's data. This is a setting that is available in
                        all major browsers.
                      </p>
                      <p className="max-w-[60rem] text-[1.6rem] leading-[2.4rem] font-medium">
                    ...
                    <div className="flex flex-col gap-[.5rem]">
                      ...
                      <p className="max-w-[60rem] text-[1.6rem] leading-[2.4rem] font-medium">
                        The Hotjar Poll & Survey widgets are services that
                        enable interaction with the Hotjar platform provided by
                        Hotjar Ltd.
                      </p>
                      <p className="max-w-[60rem] text-[1.6rem] leading-[2.4rem] font-medium">
                        <strong>Personal Data processed:</strong> Cookies, Usage
              ...
              <div className="flex flex-col items-center gap-[2.2rem] text-center xl:flex-row xl:items-start xl:text-left">
                ...
                <div className="flex flex-col gap-[1rem]">
                  ...
                  <div className="flex flex-col gap-[2rem]">
                    <div className="flex flex-col gap-[.5rem]">
                      <p className="max-w-[60rem] text-[1.6rem] leading-[2.4rem] font-medium">
                        This Website uses Trackers to measure traffic and
                        analyze User behavior to improve the Service.
                      </p>
                    </div>
                    ...
                    <div className="flex flex-col gap-[.5rem]">
                      ...
                      <p className="max-w-[60rem] text-[1.6rem] leading-[2.4rem] font-medium">
                        ...
                        of this Website, to prepare reports on its activities
                    ...
                    <div className="flex flex-col gap-[.5rem]">
                      ...
                      <p className="max-w-[60rem] text-[1.6rem] leading-[2.4rem] font-medium">
                        <strong>Personal Data processed:</strong> Cookies, Usage
                        Data and various types of Data as specified in the
              ...
              <div className="flex flex-col items-center gap-[2.2rem] text-center xl:flex-row xl:items-start xl:text-left">
                ...
                <div className="flex flex-col gap-[1rem]">
                  ...
                  <div className="flex flex-col gap-[2rem]">
                    <div className="flex flex-col gap-[.5rem]">
                      <p className="max-w-[60rem] text-[1.6rem] leading-[2.4rem] font-medium">
                        This Website uses Trackers to deliver personalized ads
                        or marketing content, and to measure their performance.
                      </p>
                    </div>
                    ...
                    <div className="flex flex-col gap-[.5rem]">
                      ...
                      <p className="max-w-[60rem] text-[1.6rem] leading-[2.4rem] font-medium">
                        X Ads conversion tracking is an analytics service
                        provided by X Corp. that connects data from the X
                        advertising network with actions performed on this
                        Website.
                      </p>
                      <p className="max-w-[60rem] text-[1.6rem] leading-[2.4rem] font-medium">
            ...
            <div className="mt-[2rem] flex flex-col gap-[2rem] text-left">
              ...
              <ul className="list-outside list-disc pl-6">
                <li className="text-[1.6rem] leading-[2.4rem] font-medium">
                  See what Cookies or other similar technologies have been set
                  on the device;
                </li>
                <li className="text-[1.6rem] leading-[2.4rem] font-medium">
          ...
          <div className="my-[4rem] flex flex-col items-center text-center md:my-[6rem] xl:items-start xl:text-left">
            ...
            <div className="mt-[2rem] flex flex-col gap-[2rem] text-left">
              <p className="text-[1.6rem] leading-[2.4rem] font-medium">
                ...
                provided by YourOnlineChoices (EU and UK), the Network
                Advertising Initiative (US) and the Digital Advertising Alliance
                (US), DAAC (Canada), DDAI (Japan) or other similar services.
                Such initiatives allow Users to select their tracking
              ...
              <p className="text-[1.6rem] leading-[2.4rem] font-medium">
                ...
                AppChoices that helps Users to control interest-based
          ...
          <div className="my-[4rem] flex flex-col items-center text-center md:my-[6rem] xl:items-start xl:text-left">
            ...
            <div className="mt-[2rem] flex flex-col gap-[2rem] text-left">
              <p className="text-[1.6rem] leading-[2.4rem] font-medium">
                ...
                Trackers. However, please note that Trackers help this Website
          ...
          <div className="my-[4rem] flex flex-col items-center text-center md:my-[6rem] xl:items-start xl:text-left">
            ...
            <div className="mt-[2rem] flex flex-col gap-[2rem] text-left">
              ...
              <p className="text-[1.6rem] leading-[2.4rem] font-medium">
                Since the use of third-party Trackers through this Website
            ...
            <div className="mt-[2rem] flex flex-col gap-[2rem] text-left">
              ...
              <div className="flex flex-col gap-[.5rem]">
                ...
                <p className="text-[1.6rem] leading-[2.4rem] font-medium">
                  ...
                  method utilized to submit the request to the server, the size
