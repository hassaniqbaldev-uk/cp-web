    ...
    <div class="main-container">
      ...
      <div class="content">
        <div class="container">
          <p class="msg-text">
            Hi ${name || "there"}, <br /> <br />
            Thank you for getting in touch with <strong>CreativePixels</strong>. We've received your message and one of our team will be back to you within 24 Hours to discuss the next steps.<br /><br />
