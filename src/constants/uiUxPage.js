import ConsultationFirstIcon from "@/assets/icons/consultation-first-icon.svg";
import FigmaDrivenIcon from "@/assets/icons/figma-driven-icon.svg";
import PerformanceOptimizedIcon from "@/assets/icons/performance-optimized-icon.svg";
import BuiltForIcon from "../assets/icons/built-for-icon.svg";
import WebDesignIcon from "@/assets/icons/web-design-icon.svg";
import EcommerceIcon from "@/assets/icons/ecommerce-icon.svg";
...
export const webDesignServiceCards = [
  {
    id: 1,
...
export const whatWeCanHelpData = [
  {
    id: 1,
    icon: WebDesignIcon,
    iconBg: "bg-[#FFC300]",
