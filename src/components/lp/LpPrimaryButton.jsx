    ...
    <motion.div initial="initial" whileHover="hover" className="inline-flex">
      ...
      >
        ...
        <span
          ...
          className="relative inline-flex h-[4rem] items-center justify-center overflow-hidden rounded-[7rem] px-[2.4rem] py-[1rem] text-[1.4rem] font-semibold md:h-[5rem] md:px-[3rem] md:text-[1.8rem]"
        >
          <motion.span
            variants={slideUp}
...
export default LpPrimaryButton;
