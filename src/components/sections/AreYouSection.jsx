...
const AreYouSection = () => {
  ...
  return (
    <section
      ref={container}
      className="relative px-[3rem] py-[10rem] xl:px-[0rem]"
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-[0] overflow-hidden">
        <CLetter2 className="absolute top-[0rem] right-[-18.7rem] w-[45rem] rotate-[-180deg]" />
      </div>

      <div className="relative z-[10] mx-auto flex max-w-[120rem] flex-col items-start">
        <div ref={labelRef}>
          <SectionLabel2
        ...
        <div className="my-[4rem] grid grid-cols-3 gap-x-[10rem] gap-y-[1rem]">
