...
const validate = (v) => {
  ...
  else if (v.fullName.trim().length < 3)
  ...
  if (v.phone?.trim() && !/^[0-9+\-\s()]{7,15}$/.test(v.phone))
    e.phone = "Please enter a valid phone number";

  if (!v.resume) e.resume = "Please upload your resume";

  if (v.portfolio?.trim() && !/^[a-zA-Z0-9.-]+\.[a-zA-Z]{2,}/.test(v.portfolio))
    e.portfolio = "Please enter a valid URL";

  return e;
};

const JobApplicationForm = ({ jobTitle = "UI/UX Product Designer", onClose }) => {
  ...
  const [fileError, setFileError] = useState(""); // immediate file-type/size feedback
    ...
    <>
      ...
      >
        ...
        <Form
          ...
          transport="multipart"
          values={{ fullName, email, phone, message, portfolio, resume: resumeFile, jobTitle }}
          validate={validate}
          enquiryEvents={false}
            ...
            <>
              ...
              <div className="mt-[2.5rem] mb-[3rem] flex w-full flex-col items-start gap-[2.5rem]">
                ...
                <fieldset className="w-full">
                  ...
                  {errors.fullName && (
                    <p id={errorId("fullName")} className="mt-[0.5rem] text-[1.3rem] text-[#F14A58]">
                      {errors.fullName}
                    </p>
                  )}
                </fieldset>
                ...
                <div className="grid w-full grid-cols-1 gap-[1.5rem] md:grid-cols-2">
                  <fieldset className="w-full">
                    ...
                    {errors.email && (
                      <p id={errorId("email")} className="mt-[0.5rem] text-[1.3rem] text-[#F14A58]">
                        {errors.email}
                      </p>
                    )}
                  </fieldset>
                  ...
                  <fieldset className="w-full">
                    ...
                    {errors.phone && (
                      <p id={errorId("phone")} className="mt-[0.5rem] text-[1.3rem] text-[#F14A58]">
                        {errors.phone}
                      </p>
                    )}
                  </fieldset>
                ...
                <fieldset className="w-full">
                  ...
                  >
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" className="text-[#625C70]">
                      <path
                  ...
                  {(fileError || errors.resume) && (
                    <p id={errorId("resume")} className="mt-[0.5rem] text-[1.3rem] text-[#F14A58]">
                      {fileError || errors.resume}
                    </p>
                  )}
                </fieldset>
                ...
                <fieldset className="w-full">
                  ...
                  {errors.portfolio && (
                    <p id={errorId("portfolio")} className="mt-[0.5rem] text-[1.3rem] text-[#F14A58]">
                      {errors.portfolio}
                    </p>
                  )}
                </fieldset>
