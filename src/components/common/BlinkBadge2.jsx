const BlinkBadge2 = ({ text }) => {
  return (
    <>
      <div className="inline-flex h-[4rem] items-center justify-center gap-[1rem] rounded-[.8rem] border border-dashed border-white/50 px-[1rem] py-[1rem] md:h-[4.4rem] md:px-[2rem]">
