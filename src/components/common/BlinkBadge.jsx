    ...
    <>
      <div className="inline-flex h-[4rem] items-center justify-center gap-[1rem] rounded-[.8rem] bg-white/20 px-[1rem] py-[1rem] md:h-[4.4rem] md:px-[2rem]">
        <div className="relative size-[1.8rem]">
          <div className="bg-secondary-orange/20 absolute top-1/2 left-1/2 size-[1.8rem] -translate-1/2 animate-ping rounded-full" />
          <div className="bg-secondary-orange absolute top-1/2 left-1/2 size-[1rem] -translate-1/2 rounded-full" />
        </div>
